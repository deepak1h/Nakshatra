        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <TabsList className="grid w-full grid-cols-5 bg-cosmic-navy/50">
              <TabsTrigger
                value="profile"
                className="data-[state=active]:bg-cosmic-purple"
              >
              ...
              <TabsTrigger
                ...
                className="data-[state=active]:bg-cosmic-purple"
              >
                {/* FIX: Changed Settings icon to ShoppingBag for semantic correctness */}
                <ShoppingBag className="w-4 h-4 mr-2" />
              ...
              {orders.length === 0 ? (
                <Card className="cosmic-bg border-cosmic-purple/30">
                  <CardContent className="text-center py-12">
                    ...
                    <p className="text-cosmic-gold/70">
                ...
                <div className="space-y-4">
                  {orders.map((order) => (
                    <Card
                      key={order.id}
                      className="cosmic-bg border-cosmic-purple/30"
                    >
              ...
              {kundaliRequests.length === 0 ? (
                <Card className="cosmic-bg border-cosmic-purple/30">
                  <CardContent className="text-center py-12">
                    ...
                    <p className="text-cosmic-gold/70">
                      Your Kundali readings will appear here
                    </p>
                  </CardContent>
                </Card>
              ) : (
